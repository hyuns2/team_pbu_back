...
public class ShortsTest extends MockEntity {
    ...
    @Test
    @DisplayName("쇼츠 리스트를 조회하는 테스트")//확인완료
    ...
    @Test
    @DisplayName("쇼츠를 단건 조회하는 테스트")//확인완료
    ...
    @Test
    @DisplayName(value = "쇼츠를 삭제하는 테스트")//확인완료
