...
public class WorthyConsumptionController {
    ...
    @PostMapping("/create")
    public ResponseEntity<HttpStatus> createWorthyConsumption(WorthyConsumptionRequestDto.CreationRequest worthyConsumptionRequestDto){
            worthyConsumptionService.createWorthyConsumption(worthyConsumptionRequestDto);
            return new ResponseEntity<>(HttpStatus.CREATED);
    }
    @GetMapping("/{worthyConsumptionId}")//다른 스타일로 짜보려고 노력함
...
//        return new ResponseEntity<>(WorthyConsumptionResponseDto, HttpStatus.OK);
//    }
    @PutMapping("/{worthyConsumptionId}")
    ...
    @PutMapping("/{worthyConsumptionId}")
    public ResponseEntity<HttpStatus> updateUrlContent(@PathVariable(name = "worthyConsumptionId") Long worthyConsumptionId, @RequestBody WorthyConsumptionRequestDto.UpdateUrlRequest worthyConsumptionRequestDto){
        //pathVariable과 dto의 id값이 동일한가 valid 검사 해야 함
        worthyConsumptionService.updateUrlWorthyConsumption(worthyConsumptionRequestDto);
        return new ResponseEntity<>(HttpStatus.OK);
    }
    @PutMapping("/{worthyConsumptionId}")
    public ResponseEntity<HttpStatus> updatePriceContent(@PathVariable(name = "worthyConsumptionId") Long worthyConsumptionId, @RequestBody WorthyConsumptionRequestDto.UpdatePriceRequest worthyConsumptionRequestDto){
        //pathVariable과 dto의 id값이 동일한가 valid 검사 해야 함
        worthyConsumptionService.updatePriceWorthyConsumption(worthyConsumptionRequestDto);
        return new ResponseEntity<>(HttpStatus.OK);
    }
    @PutMapping("/{worthyConsumptionId}")
    public ResponseEntity<HttpStatus> updatePlaceContent(@PathVariable(name = "worthyConsumptionId") Long worthyConsumptionId, @RequestBody WorthyConsumptionRequestDto.UpdatePlaceRequest worthyConsumptionRequestDto){
        //pathVariable과 dto의 id값이 동일한가 valid 검사 해야 함
