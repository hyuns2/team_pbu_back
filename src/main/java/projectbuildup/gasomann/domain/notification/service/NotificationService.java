package projectbuildup.gasomann.domain.notification.service;

import lombok.RequiredArgsConstructor;
import org.springframework.data.domain.Sort;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import projectbuildup.gasomann.domain.notification.dto.NotificationDto;
import projectbuildup.gasomann.domain.notification.entity.NotificationEntity;
import projectbuildup.gasomann.domain.notification.entity.NotificationType;
import projectbuildup.gasomann.domain.notification.repository.NotificationRepository;
...
import projectbuildup.gasomann.global.error.exception.CNotificationNotFoundException;
